...
- (void)setUp {
    ...
    _userAgent   = @"kissmetrics-ios/2.0";
...
- (void)test_createUrlForEventAndProperties {
    ...
    NSString *expectedUrl = @"/e?_k=b8f68fe5004d29bcd21d3138b43ae755a16c12cf&_c=mobile_app&_u=kissmetrics-ios/2.0&_p=testuser%40example.com";
...
- (void)test_createUrlForProperties {
    ...
    NSString *expectedUrl = @"/s?_k=b8f68fe5004d29bcd21d3138b43ae755a16c12cf&_c=mobile_app&_u=kissmetrics-ios/2.0&_p=testuser%40example.com&_d=1&_t=";
...
- (void)test_createUrlForIdentity {
    ...
    NSString *expectedUrl = @"/a?_k=b8f68fe5004d29bcd21d3138b43ae755a16c12cf&_c=mobile_app&_u=kissmetrics-ios/2.0&_p=testnewuser%40example.com&_n=testolduser%40example.com";
